...
namespace core
{
	...
	namespace wim
	{
		...
		class im : public base_im , public std::enable_shared_from_this<im>
		{
			...
			virtual void add_chat(int64_t _seq, const std::string& _m_chat_name, const std::string& _m_chat_members) override;
		...
		public:
			...
			void on_event_buddies_list(fetch_event_buddy_list* _event);
			void on_event_presence(fetch_event_presence* _event);
			void on_event_dlg_state(fetch_event_dlg_state* _event);
			void on_event_hidden_chat(fetch_event_hidden_chat* _event);
			void on_event_diff(fetch_event_diff* _event);
			void on_event_my_info(fetch_event_my_info* _event);
			void on_event_user_added_to_buddy_list(fetch_event_user_added_to_buddy_list* _event);
            void on_event_typing(fetch_event_typing* _event);
            void on_event_permit(fetch_event_permit* _event);
