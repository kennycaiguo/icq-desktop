...
namespace core
{
    ...
    namespace stickers
    {
        ...
        public:
            ...
            bool sticker_loaded(const download_task& _task, /*out*/ std::list<int64_t>&);
        ...
        public:
            ...
            std::shared_ptr<result_handler<const parse_result&>> parse(
                ...
                bool _insitu);
            std::shared_ptr<result_handler<const load_result&>> load_from_local();
            ...
            std::shared_ptr<result_handler<bool, const std::list<int64_t>&>> on_sticker_loaded(const download_task& _task);
