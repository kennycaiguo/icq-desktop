...
void dlg_state::serialize(icollection* _collection, const time_t _offset, const time_t _last_successful_fetch) const
{
	...
	get_last_message().serialize(msg_coll.get(), _offset);
