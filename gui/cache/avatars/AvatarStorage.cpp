...
namespace Logic
{
	...
	QString AvatarStorage::GetLocal(const QString& aimId, const QString& display_name, const int sizePx)
	{
		bool isDefault = false;
		QPixmapSCptr avatar = Get(aimId, display_name, sizePx, true, isDefault);
