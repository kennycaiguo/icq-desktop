...
void core::im_container::on_voip_call_message(int64_t _seq, coll_helper& _params)
{
	...
	if (type == "voip_call_start") {
        ...
        windowParams.hwnd = (void*)(uintptr_t)_params.get_value_as_int("handle");
        ...
        void* hwnd = (void*)(uintptr_t)_params.get_value_as_int("handle");
...
void core::im_container::on_add_chat(int64_t _seq, coll_helper& _params)
{
	...
	im->add_chat(
		...
		_params.get_value_as_string("m_chat_members"));
}
...
{
    g_core->insert_event((core::stats::stats_event_names)_params.get_value_as_int("event"));
}
