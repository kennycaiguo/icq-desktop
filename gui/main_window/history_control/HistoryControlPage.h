...
namespace Ui
{
	...
	private:
		...
		PositionInfoListIter getPositionInfoByKey(const Logic::MessageKey& key);
		...
		void recalculateWidgetsPositions();
		const Ui::MessageItem* getMessageItemAt(const qint32 pos) const;
		...
		ContextMenu*							menu_;
		PositionInfoList			            position_list_;
