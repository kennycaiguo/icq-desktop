...
namespace Ui
{
	...
	void NotificationCenterManager::DisplayNotification(const QString& aimId, const QString& message)
	{
        ...
        {
            QString imagePath = Logic::GetAvatarStorage()->GetLocal(aimId, displayName, Utils::scale_value(64));
            NSImage * ava = [[[NSImage alloc] initWithContentsOfFile:(NSString *)CFBridgingRelease(imagePath.toCFString())] autorelease];
