...
namespace core
{
	...
	public:
		...
		virtual void add_chat(int64_t _seq, const std::string& _m_chat_name, const std::string& _m_chat_members) = 0;
		...
		virtual void on_voip_proto_msg(bool allocate, const char* data, unsigned len);
