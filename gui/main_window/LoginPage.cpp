...
namespace Ui
{
		...
		, timer_(new QTimer(this))
	{
        ...
        prev_page_link_ = new QPushButton(back_button_widget);
        ...
        */
        ...
        next_page_link_->setProperty("NextPageButton", QVariant(true));
	...
	void LoginPage::switchLoginType()
	{
        ...
        GetDispatcher()->post_stats_to_core(login_staked_widget_->currentIndex() == SUBPAGE_UIN_LOGIN_INDEX 
            ? core::stats::stats_event_names::reg_login_uin : core::stats::stats_event_names::reg_login_phone);
	}
