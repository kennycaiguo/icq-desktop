...
namespace Ui
{
        ...
        info_(new TextEmojiWidget(this, Utils::FontsFamily::SEGOE_UI_LIGHT, Utils::scale_value(16), QColor(0x28, 0x28, 0x28), Utils::scale_value(27) - name_->descent()))
    {
        ...
        Logic::GetContactListModel()->get_contact_profile(aimid_, [this, wr_ref](Logic::profile_ptr _profile)
        {
        ...
        info_widget_(new ContactInfoWidget(this, _aimid))
    {
        ...
        setFixedHeight(Utils::scale_value(308));
        root_layout_->setSpacing(0);
        root_layout_->setContentsMargins(0, 0, 0, 0);

        root_layout_->addSpacing(Utils::scale_value(avatar_upper_space));
